...
public abstract class AuthService {
    ...
    protected static Authentication createAuthentication(String actor, @NonNull String... roles) {
    ...
    protected record Credentials(String username, @ToString.Exclude String password) {
    }
}
